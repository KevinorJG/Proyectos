...
public class Principal extends javax.swing.JFrame {
    OperacionesEmpleado operacionesEmpleado;
    /**
     * Creates new form Principal
     */
    public Principal() {
        initComponents();
        operacionesEmpleado = new OperacionesEmpleado();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Registrar Docente");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // Evento para dar inicio al Registrar docente
        RegistroDocente docente = new RegistroDocente();
        docente.setOperacion(operacionesEmpleado);
